...
export default function Movie() {
    ...
    return (
        <div className={"p-4 min-w-[400px] flex flex-wrap gap-4"}>
            {!hasRequested.current && <span className="loading loading-spinner loading-lg"></span>}

            <div className="flex flex-col gap-8 p-8 bg-base-200 rounded-lg shadow-lg w-full lg:w-3/4 xl:w-2/3 mx-auto">
